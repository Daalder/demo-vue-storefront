    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex px-2 lg:px-0">
                <div class="flex-shrink-0 flex items-center w-12 xs:w-24 sm:w-64">
                    <a href="/">
                        <img src="/images/logo-blue.png" srcset="/images/logo-blue2x.png 2x" class="h-auto w-auto"
                             alt="$Daalder Shop UI">
                    </a>
                </div>
            ...
            <div class="hidden lg:ml-4 lg:flex lg:items-center">
                <a href="/cart"
                   class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-100 transition ease-in-out duration-150">
                    <span class="material-icons mr-4 h-6 w-6 text-gray-500 group-hover:text-gray-500 group-focus:text-gray-600 transition ease-in-out duration-150">shopping_cart</span>
